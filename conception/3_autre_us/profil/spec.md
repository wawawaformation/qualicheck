...
| Rétention — compte | **12 mois** d'inactivité → avertissement → confirmation → suppression ; suppression du compte (inactivité ou demande explicite) **cascade** sur toutes les données liées — discussions (US2), audits (US1), et toute autre donnée future rattachée au compte — aucune donnée orpheline | Un compte représente une relation dans la durée (usage ponctuel possible, ex. un audit qualité par trimestre) — une durée plus longue qu'au niveau discussion évite de supprimer des comptes encore légitimement utilisés ; le droit à l'effacement porte sur le compte dans son ensemble, pas discussion par discussion |
