...
- **`ingestion/`** : modules du pipeline d'ingestion — `acquisition.py`, `aggregation.py`, `enrichment.py`, `stockage.py`, `chunking.py`, `embedding.py`. Détail et justification des choix : `conception/2_ingestion/ingestion.md`.
